...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val jsSwitch = Switch(this).apply {
            isChecked = PreferenceManager.getDefaultSharedPreferences(this@SettingsActivity)
                .getBoolean("enable_javascript", true)
            setOnCheckedChangeListener { _, isChecked ->
                PreferenceManager.getDefaultSharedPreferences(this@SettingsActivity)
                    .edit().putBoolean("enable_javascript", isChecked).apply()
            }
        }
